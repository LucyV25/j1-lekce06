...
public class NakupniSeznam {
    ...
    private void naplnSeznam() {
        //TODO
        seznam.add(new Polozka("jablka",2,"kg"));
        seznam.add(new Polozka("maslo",1,"ks"));
        seznam.add(new Polozka("banan",3,"ks"));
        seznam.add(new Polozka("rohlik",3,"ks"));
    }
    ...
    private void pridejDalsiPolozku() {
        //TODO
        seznam.add(new Polozka("mleko",1,"ks"));
    }
